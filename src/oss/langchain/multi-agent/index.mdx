...
<Tabs>
  <Tab title="Subagents">
    ...
    The main agent is the only agent that can directly communicate with the user.
  </Tab>
  ...
  <Tab title="Handoffs">
    ...
    Any agent can communicate with the user directly.
  </Tab>
  ...
  <Tab title="Skills">
    ...
    The agent often loads skills via a `load_skill` tool.
  </Tab>
  ...
  <Tab title="Router">
    ...
    All queries run through the router, which decides which agents to call.
  </Tab>
</Tabs>
