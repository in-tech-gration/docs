...
Below are some examples of how you can build multi-agent systems using tool calling:
...
Below are some examples of how you can build multi-agent systems using handoffs:
...
Here's a minimal example showing how agents hand off control:
