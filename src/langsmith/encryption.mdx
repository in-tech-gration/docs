...
<Note>
Requires Agent Server version 0.6.9+ and Python SDK version `langgraph-sdk>=0.3.1`.
</Note>

<Warning>
Agent Server versions 0.5.34–0.6.8 included a pre-release version of custom encryption. Data encrypted with these versions will be corrupted when upgrading to 0.6.9+. Do not use custom encryption on these versions.
</Warning>
