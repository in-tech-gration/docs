...
<Note>
Ensure that you're in the correct namespace when you run the commands in this section. Or, specify the namespace explictly with the `-n` flag. For example:

```bash
kubectl get deployments -n langsmith
```
</Note>
