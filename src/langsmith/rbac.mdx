...
Management access for day-to-day operations including workspace and user management, but cannot manage Organization Admins or create organization-wide API keys.
...
**Key Capabilities:**
- Create and manage [workspaces](/langsmith/set-up-a-workspace)
...
- Create workspace-scoped API keys and service accounts
- View organization [usage](/langsmith/administration-overview#usage-limits) and analytics
...
- Cannot create organization-wide (non-workspace-specific) API keys
